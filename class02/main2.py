...
p2 = Product("Mouse", 5) # i dont want to put stock here
print(p2.stock)
...
# the moment we introducee positional keywords, all the following arguments
# need to follow that same format
